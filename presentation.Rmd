...
sensor_readingsRH %>%
  ...
  ggtitle("Mean Humidity by Sensor over time")
```
]
---
.center[
...
sensor_readingsRH %>%
  ...
  scale_x_date(date_labels = "%Y-%m-%d", date_breaks  = "10 days") +
  theme(axis.text.x=element_text(angle=60, hjust=1, size = 8)) +
  ggtitle("Mean Humidity over time")
```
]
---
.center[
...
sensor_readingsRH %>%
  ...
  theme_ipsum() +
  xlab("") +
  ylab("Median Humidity (%)") +
  scale_x_date(date_labels = "%Y-%m-%d", date_breaks  = "10 days") +
  theme(axis.text.x=element_text(angle=60, hjust=1, size = 8)) +
  ggtitle("Median Humidity over time")
```
]
...
sensor_readingsRH %>%
  ...
  theme_ipsum() +
  xlab("Month") +
  ylab("Mean and Median Humidity (%)") +
  labs(color="Legend") +
  scale_x_continuous(breaks = seq(1,12,1)) +
  ggtitle("Mean and Median Humidity over time")
```
]
...
sensor_readingsRH %>%
  ...
  ggtitle("Mean Humidity throughout the day")
```
]
