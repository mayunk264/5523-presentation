...
N.B: Just two days during all the year presented daily median below 30%: 
- **21/11/2019**
- **31/01/2020**
...
* **Only nights are more confortable!**
...
* During the winter (May-Aug), always above 60% of RH!
* Another months --> only nights are more comfortable (below 60%).
---
.center[
#In Conclusion
]
...
- **Nights** in Melbourne are **generally comfortable** with average relative humidity levels **below 60%** (excepts during the winter). 

- From **6am to 9pm**, however, average relative humidity generally **rises above 60%** (6am to 7pm if September, November or December months).
